...
<head>
    ...
    <style>
        ...
        .left-side-menu {
            ...
            top: 0;
            left: 0;
            padding-top: 80px; /* Adjusted to make space for the top bar */
            display: flex;
            flex-direction: column;
            align-items: flex-start;
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
            transition: width 0.3s ease;
            z-index: 998; /* Ensure the menu is behind the top bar */
        }
        ...
        .toggle-button {
            position: absolute;
            top: 30px; /* Adjusted to align with top bar height */
            right: -20px;
            width: 40px;
            height: 40px;
            background-color: #2c3e50;
...
<body>
    ...
    <div class="top-bar">
        ...
        <div class="directeur-option">
            ...
            <a href="#">chef <i class="fas fa-chevron-down"></i></a>
            <div class="directeur-dropdown">
                
                <a href="chef_deconnexion.php"><i class="fas fa-sign-out-alt"></i> Déconnexion</a>
            </div>
        </div>
    </div>
